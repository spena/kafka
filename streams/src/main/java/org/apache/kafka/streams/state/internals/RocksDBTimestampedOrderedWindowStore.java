...
public class RocksDBTimestampedOrderedWindowStore extends WrappedStateStore<SegmentedBytesStore, Object, Object>
    ...
    RocksDBTimestampedOrderedWindowStore(final SegmentedBytesStore bytesStore,
    ...
    public void put(final Bytes key, final byte[] value, final long windowStartTimestamp) {
        ...
        if (!(value == null && retainDuplicates)) {
            ...
            wrapped().put(TimestampedOrderedKeySchema.toStoreKeyBinary(key, windowStartTimestamp, seqnum), value);
        }
    }

    @Override
    public void deleteRange(final long timeFrom, final long timeTo) {
        // todo: implement
    }

    @Override
    public byte[] fetch(final Bytes key, final long timestamp) {
        return wrapped().get(TimestampedOrderedKeySchema.toStoreKeyBinary(key, timestamp, seqnum));
    }
    ...
    public WindowStoreIterator<byte[]> fetch(final Bytes key, final long timeFrom, final long timeTo) {
        ...
        return new TimestampedOrderedWindowStoreIteratorWrapper(bytesIterator, windowSize).valuesIterator();
    }
    ...
    public KeyValueIterator<Windowed<Bytes>, byte[]> fetch(final Bytes keyFrom,
        ...
        return new TimestampedOrderedWindowStoreIteratorWrapper(bytesIterator, windowSize).keyValueIterator();
    }
