...
public class JoinSideAndKeySerializer<K> implements WrappingNullableSerializer<JoinSideAndKey<K>, K, Void> {
    public final Serializer<K> keySerializer;

    JoinSideAndKeySerializer(final Serializer<K> keySerializer) {
