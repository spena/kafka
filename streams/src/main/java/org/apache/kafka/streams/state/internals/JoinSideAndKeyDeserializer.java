...
public class JoinSideAndKeyDeserializer<K> implements WrappingNullableDeserializer<JoinSideAndKey<K>, K, Void> {
    public final Deserializer<K> keyDeserializer;

    public JoinSideAndKeyDeserializer(final Deserializer<K> keyDeserializer) {
    ...
    @Override
    public JoinSideAndKey<K> deserialize(final String topic, final byte[] joinSideAndKey) {
        ...
        return JoinSideAndKey.make(thisJoin, key);
    }
