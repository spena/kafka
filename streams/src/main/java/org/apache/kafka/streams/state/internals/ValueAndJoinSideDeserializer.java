...
public class ValueAndJoinSideDeserializer<V1, V2> implements WrappingNullableDeserializer<ValueAndJoinSide<V1, V2>, Void, ValueAndJoinSide<V1, V2>> {
    public final Deserializer<V1> thisDeserializer;
    public final Deserializer<V2> otherDeserializer;

    public ValueAndJoinSideDeserializer(final Deserializer<V1> thisDeserializer, final Deserializer<V2> otherDeserializer) {
    ...
    @Override
    public ValueAndJoinSide<V1, V2> deserialize(final String topic, final byte[] joinedValues) {
        ...
        return ValueAndJoinSide.make(thisValue, otherValue);
    }
    ...
    @Override
    public void setIfUnset(final Deserializer<Void> defaultKeyDeserializer, final Deserializer<ValueAndJoinSide<V1, V2>> defaultValueDeserializer) {
