...
public class KeyAndJoinSideSerde<K> extends WrappingNullableSerde<KeyAndJoinSide<K>, K, Void> {
    public KeyAndJoinSideSerde(final Serde<K> keySerde) {
        super(
            new KeyAndJoinSideSerializer<>(requireNonNull(keySerde, "keySerde was null").serializer()),
            new KeyAndJoinSideDeserializer<>(requireNonNull(keySerde, "keySerde was null").deserializer())
        );
    }
}
