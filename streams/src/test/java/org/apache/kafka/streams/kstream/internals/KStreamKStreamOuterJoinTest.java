...
public class KStreamKStreamOuterJoinTest {
    ...
    public void testWindowing() {
        ...
        try (final TopologyTestDriver driver = new TopologyTestDriver(builder.build(), props)) {
            ...
            // push two items to the primary stream; the other window is empty; this should not produce items because window has not expired
            // w1 = {}
            // w2 = {}
    ...
    private void testUpperWindowBound(final int[] expectedKeys,
        ...
        // push four items with larger and increasing timestamp (out of window) to the other stream; this should prodice 2 expired non-joined records
        // w1 = { 0:A0 (ts: 0), 1:A1 (ts: 0) }
        // w2 = { 0:a0 (ts: 0), 1:a1 (ts: 0), 2:a2 (ts: 0), 3:a3 (ts: 0) }
        // --> w1 = { 0:A0 (ts: 0), 1:A1 (ts: 0) }
        // --> w2 = { 0:a0 (ts: 0), 1:a1 (ts: 0), 2:a2 (ts: 0), 3:a3 (ts: 0),
        ...
        /*processor.checkAndClearProcessResult(new KeyValueTimestamp<>(0, "C0+null", 1205),
            new KeyValueTimestamp<>(0, "D0+null", 1205),
            new KeyValueTimestamp<>(0, "E0+null", 1205),
            new KeyValueTimestamp<>(0, "F0+null", 1205),
            new KeyValueTimestamp<>(1, "D1+null", 1205),
            new KeyValueTimestamp<>(1, "E1+null", 1205),
            new KeyValueTimestamp<>(1, "F1+null", 1205),
            new KeyValueTimestamp<>(2, "E2+null", 1205),
            new KeyValueTimestamp<>(2, "F2+null", 1205),
            new KeyValueTimestamp<>(3, "F3+null", 1205));*/
        processor.checkAndClearProcessResult(new KeyValueTimestamp<>(0, "C0+null", 1205),
            new KeyValueTimestamp<>(0, "D0+null", 1205),
            new KeyValueTimestamp<>(1, "D1+null", 1205),
            new KeyValueTimestamp<>(0, "E0+null", 1205),
